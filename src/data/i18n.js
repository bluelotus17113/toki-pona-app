...
export const STRINGS = {
  ...
  settingsAppearance: { es: 'apariencia',                         en: 'appearance' },
  settingsTheme:      { es: 'tema',                               en: 'theme' },
  settingsTheme_light:{ es: 'claro',                              en: 'light' },
  settingsTheme_dark: { es: 'oscuro',                             en: 'dark' },
  settingsTheme_sepia:{ es: 'sepia',                              en: 'sepia' },
  settingsLanguage:   { es: 'idioma',                             en: 'language' },
  settingsAudio:      { es: 'audio',                              en: 'audio' },
  settingsSoundEffects:{ es: 'efectos de sonido',                 en: 'sound effects' },
  settingsNotifications:{ es: 'notificaciones',                   en: 'notifications' },
  settingsDailyReminder:{ es: 'recordatorio diario',              en: 'daily reminder' },
  settingsDailyReminderSub:{ es: 'palabra del día por notificación', en: 'word of the day by notification' },
  settingsNotifHour:  { es: 'hora del aviso',                     en: 'reminder hour' },
  settingsData:       { es: 'datos',                              en: 'data' },
  // copia de seguridad
  backupExport:       { es: 'guardar copia de seguridad',         en: 'save backup' },
  backupExportHelp:   { es: 'guarda tu progreso en un archivo. sin esto, reinstalar la app lo borra todo.', en: 'saves your progress to a file. without it, reinstalling the app erases everything.' },
  backupImport:       { es: 'restaurar copia',                    en: 'restore backup' },
  backupImportHelp:   { es: 'reemplaza tu progreso actual por el del archivo.', en: 'replaces your current progress with the one in the file.' },
  backupSaved:        { es: '✓ copia guardada en {location}',     en: '✓ backup saved to {location}' },
  backupSavedWeb:     { es: '✓ copia descargada: {location}',     en: '✓ backup downloaded: {location}' },
  backupWorking:      { es: 'guardando…',                         en: 'saving…' },
  backupRestoreConfirm:{ es: 'Copia del {date}:\n\n{lessons} lecciones · {xp} XP · {mani} mani · {achievements} logros\n\nEsto REEMPLAZA tu progreso actual y no se puede deshacer. ¿Continuar?', en: 'Backup from {date}:\n\n{lessons} lessons · {xp} XP · {mani} mani · {achievements} achievements\n\nThis REPLACES your current progress and cannot be undone. Continue?' },
  backupRestored:     { es: '✓ progreso restaurado, recargando…', en: '✓ progress restored, reloading…' },
  backupErrNotJson:   { es: 'ese archivo no es una copia válida.', en: 'that file is not a valid backup.' },
  backupErrWrongApp:  { es: 'esa copia es de otra app.',          en: 'that backup is from another app.' },
  backupErrFormat:    { es: 'esa copia es de una versión más nueva de la app.', en: 'that backup is from a newer version of the app.' },
  backupErrNoData:    { es: 'la copia está vacía o dañada.',      en: 'the backup is empty or damaged.' },
  backupErrWrite:     { es: 'no se pudo guardar el archivo.',     en: 'could not save the file.' },
  settingsResetOnboarding:{ es: 'volver a ver el tutorial',       en: 'show tutorial again' },
  settingsResetOnboardingHelp:{ es: 'reinicia solo el tutorial. tu progreso no se toca.', en: 'resets only the tutorial. your progress stays.' },
  settingsOnboardingResetConfirm:{ es: '¿reiniciar el tutorial?', en: 'reset the tutorial?' },
  settingsResetProgress:{ es: 'reiniciar progreso',               en: 'reset progress' },
  settingsResetProgressHelp:{ es: 'borra TODO: lecciones, XP, mani, cuentos, logros. no se puede deshacer.', en: 'erases EVERYTHING: lessons, XP, mani, stories, achievements. cannot be undone.' },
  settingsResetConfirm:{ es: '¿Borrar todo el progreso? esto no se puede deshacer.', en: 'Delete all progress? this cannot be undone.' },
  settingsResetConfirm2:{ es: '¿Estás 100% segurx? última oportunidad.', en: 'Are you 100% sure? last chance.' },
  settingsAbout:      { es: 'acerca de',                          en: 'about' },
  settingsLessons:    { es: 'lecciones',                          en: 'lessons' },
  settingsMinigames:  { es: 'minijuegos',                         en: 'minigames' },
  settingsAchievements:{ es: 'logros',                            en: 'achievements' },
  settingsCredits:    { es: 'hecho con cariño · toki pona li pona a!', en: 'made with love · toki pona li pona a!' },
